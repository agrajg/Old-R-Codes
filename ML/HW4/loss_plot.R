...
w.data2 <- read.table("WmatN1_100.txt", quote="\"", comment.char="",row.names=NULL)
w.mat.iter<- data.matrix(w.data2, rownames.force = NA)[,-1]
...
plot(k,l.01, type = "n", main = "L_01", xlab ="K", ylab="loss")
